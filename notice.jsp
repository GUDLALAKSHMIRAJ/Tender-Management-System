...
<body>
          ...
          &nbsp; Latest Updates and Notice</h4>
            ...
            <%
                ...
                try{
                	noticeConn = DBUtil.provideConnection();
                	PreparedStatement ps = noticeConn.prepareStatement("select * from notice");
                ...
                <p style="font-weight: bold;">
                	<span class="glyphicon glyphicon-hand-right" style="color: #3743fa;"></span>
	               <strong style="color:red"><%= noticeTitle %></strong>
	               <br><br><%= noticeInfo %>
               </p>
              <hr/>
                		<%
