...
<div class="tm-welcome-bar">
  <i class="fa fa-pencil-square-o"></i> &nbsp; Notice Management &mdash; Update Notices
</div>
  ...
  <div class="col-md-8">
    <div class="tm-glass-panel">
      ...
      <div id="show" class="tm-status-box">
        ...
        Edit the given Notice Title and Description in the given box and click on <strong>Update</strong>
      </div>

      <div class="tm-table-header tm-header-purple">
        <i class="fa fa-pencil"></i> &nbsp; All Notices &mdash; Select One to Update
      </div>
          ...
          <tbody>
            ...
            <tr class="tm-row <%= (rowNum % 2 == 0) ? "tm-row-alt" : "" %>">
              ...
              <td class="tm-notice-title">
                <i class="fa fa-bullhorn" style="color:#8e44ad;margin-right:5px;"></i>
                <strong><%=noticeTitle%></strong>
              </td>
              <td class="tm-notice-desc"><%=noticeDesc%></td>
              <td>
                <a href="updateNoticeForm.jsp?nid=<%=noticeId%>">
                  <button class="tm-btn tm-btn-update">
