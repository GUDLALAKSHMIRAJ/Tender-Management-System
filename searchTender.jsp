      ...
      <div class="tm-table-responsive">
        ...
        <% if (tenderList == null || tenderList.isEmpty()) { %>
          <div class="tm-search-empty">
            ...
            <small>Try searching by exact Tender ID or Tender Name.</small>
          </div>
        <% } else { %>
        ...
        <table class="tm-table">
          <thead>
            <tr>
              ...
              <th><i class="fa fa-file-text-o"></i> Tender Name</th>
          ...
          <tbody>
            ...
            <tr class="tm-row <%= (rowNum % 2 == 0) ? "tm-row-alt" : "" %>">
              ...
              <td><i class="fa fa-map-marker" style="color:#e74c3c;margin-right:4px;"></i><%=tloc%></td>
