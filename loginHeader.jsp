	...
	<div class="container">
		<div class="navbar-header">
			...
			<a href="#" class="pull-left"> <img src="images/logo.png"
				alt="Lakshmi Raj" width="70px" height="70px" />
			</a> <a class="navbar-brand" href="#"><h1
					style="margin: 0; padding: 10;">Tender Management System</h1></a> <a
				href="#"><p style="margin-top: 10px;">Lakshmi Raj Project</p></a> <a
				href="#">
		...
		<ul class="nav navbar-nav navbar-right menusize pull-right">
			<!-- Login or signup in right top corner-->
